...
#Region "■ProcessingCode■"
    ...
    '*
    '*********************************************************************************************************
    Public Sub New(ByVal P1 As Integer, ByVal P2 As String, ByVal P3 As Boolean, Optional ByVal P4 As String = "", Optional ByVal P5 As String = "", Optional ByVal P6 As UserInfo = Nothing, Optional ByVal P7 As Form = Nothing)
        MyBase.New()
        '
        InitializeComponent()
        '
...
EXIT_SUB:
    ...
    Private Sub FNC_PRG_INT()
        ...
        Try
            ...
            '
            '呼出元ﾌｫｰﾑ検査
            If D_OWN_FRM.Name.Equals("frm_M003_ins") Then
                D_OBJ = True
...
EXIT_FUNCTION:
    ...
    Private Function FNC_SCR_CHK() As Boolean
        ...
        Try
            ...
            D_ERR.FNC_FID_INT()
            '
            If TXT_部コード_FROM.Text.Equals("") Then
                TXT_部コード_FROM.Text = "0"
            End If
            If TXT_部コード_TO.Text.Equals("") Then
                TXT_部コード_TO.Text = "99"
            End If
        Catch ex As Exception
            FNC_ERR_RTN(ex)
    ...
    Private Function FNC_CMD_EXC(ByVal P1 As String) As Boolean
        ...
        Try
            ...
            D_SQL = D_SPC & "'" &
                    ...
                    C_COM_COD & "," &
                    C_COM_COD & "," &
                    FNC_SQL_VAL(TXT_部コード_FROM) & "," &
                    FNC_SQL_VAL(TXT_部コード_TO) & "," &
                    FNC_SQL_VAL(TXT_名称)
            '
...
EXIT_FUNCTION:
    ...
    Private Sub FNC_F06()
        '
        Try
            FNC_STP_XID("P", LST_Viw, D_LST_TBL, D_FND_IDX, TXT_部コード_FROM)
        Catch ex As Exception
            FNC_ERR_RTN(ex)
        End Try
EXIT_FUNCTION:
    ...
    Private Sub FNC_F07()
        '
        Try
            FNC_STP_XID("N", LST_Viw, D_LST_TBL, D_FND_IDX, TXT_部コード_FROM)
        Catch ex As Exception
            FNC_ERR_RTN(ex)
        End Try
EXIT_FUNCTION:
...
EXIT_SUB:
    ...
    Private Sub frm_M003_fnd_Disposed(sender As Object, e As EventArgs) Handles Me.Disposed
        '
        Try
