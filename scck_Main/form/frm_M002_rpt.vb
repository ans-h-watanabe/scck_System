...
#Region "■ProcessingCode■"
    ...
    '*
    '*********************************************************************************************************
    Public Sub New(ByVal P1 As Form, P2 As String, P3 As frm_Main)
        MyBase.New()
        '
        InitializeComponent()
        '
...
EXIT_FUNCTION:
    ...
    Private Function FNC_SCR_CHK() As Boolean
        ...
        Try
            ...
            End If
            '
            If TXT_業務分類区分_FROM.Text.Equals("0") OrElse TXT_業務分類区分_FROM.Text.Equals("") Then
                TXT_業務分類区分_FROM.Text = "0"
            End If
            If TXT_業務分類区分_TO.Text.Equals("0") OrElse TXT_業務分類区分_TO.Text.Equals("") Then
                TXT_業務分類区分_TO.Text = "99"
            End If
        Catch ex As Exception
            FNC_ERR_RTN(ex)
...
EXIT_FUNCTION:
    ...
    Private Sub FNC_CMD_EXC()
        ...
        Try
            ...
            End If
            '
            D_SQL = "SPC_M002_RPT1 " & C_COM_COD & "," & C_COM_COD & "," & FNC_SQL_VAL(TXT_業務分類区分_FROM) & "," & FNC_SQL_VAL(TXT_業務分類区分_TO) & "," & FNC_SQL_VAL(TXT_名称)
            '
...
EXIT_FUNCTION:
    ...
    Private Sub frm_M002_rpt_Disposed(sender As Object, e As EventArgs) Handles Me.Disposed
        '
        Try
...
EXIT_FUNCTION:
    ...
    Private Sub frm_M002_rpt_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        '
        Try
