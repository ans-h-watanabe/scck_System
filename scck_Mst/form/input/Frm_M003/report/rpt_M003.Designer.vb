...
Partial Public Class rpt_M003
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(rpt_M003))
        Me.Detail = New GrapeCity.ActiveReports.SectionReportModel.Detail()
        Me.PageHeader = New GrapeCity.ActiveReports.SectionReportModel.PageHeader()
        Me.PageFooter = New GrapeCity.ActiveReports.SectionReportModel.PageFooter()
        Me.LBL_略称 = New GrapeCity.ActiveReports.SectionReportModel.Label()
        Me.LBL_部コード = New GrapeCity.ActiveReports.SectionReportModel.Label()
        ...
        Me.FID_部コード = New GrapeCity.ActiveReports.SectionReportModel.TextBox()
        ...
        CType(Me.LBL_部コード, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        CType(Me.FID_部コード, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.Detail.Controls.AddRange(New GrapeCity.ActiveReports.SectionReportModel.ARControl() {Me.FID_名称, Me.Line5, Me.FID_部コード, Me.FID_略称, Me.FID_登録ユーザーID, Me.FID_登録ユーザー名, Me.FID_登録日時, Me.FID_更新ユーザーID, Me.FID_更新ユーザー名, Me.FID_更新日時})
        ...
        Me.PageHeader.Controls.AddRange(New GrapeCity.ActiveReports.SectionReportModel.ARControl() {Me.LBL_略称, Me.LBL_部コード, Me.LBL_TTL, Me.Label2, Me.LBL_印刷日時, Me.Label3, Me.Label4, Me.TXT_現ページ, Me.TXT_総ページ, Me.LBL_PRG_IDS, Me.LBL_名称, Me.FID_事業所名, Me.LBL_登録情報, Me.LBL_更新情報, Me.Line6, Me.Line4})
    ...
    "justify; vertical-align: middle"
        Me.LBL_略称.Text = "略称"
        Me.LBL_略称.Top = 0.25!
        Me.LBL_略称.Width = 0.8125!
        '
        'LBL_部コード
        '
        Me.LBL_部コード.Height = 0.1875!
        Me.LBL_部コード.HyperLink = Nothing
        Me.LBL_部コード.Left = 0!
        Me.LBL_部コード.MultiLine = False
        Me.LBL_部コード.Name = "LBL_部コード"
        Me.LBL_部コード.Style = "font-family: \00FF2D\00FF33\000020\00660E\00671D; font-size: 9.75pt; text-align: " &
    "justify; vertical-align: middle"
        Me.LBL_部コード.Text = "部ｺｰﾄﾞ"
        Me.LBL_部コード.Top = 0.25!
        Me.LBL_部コード.Width = 0.5!
        '
        'LBL_TTL
        '
        Me.LBL_TTL.Height = 0.25!
        Me.LBL_TTL.HyperLink = Nothing
        Me.LBL_TTL.Left = 4.375!
    ...
    "text-align: center; vertical-align: middle"
        Me.LBL_TTL.Text = "部マスターリスト"
        Me.LBL_TTL.Top = 0!
        Me.LBL_TTL.Width = 1.875!
        '
        'Label2
        '
    ...
    "left; vertical-align: bottom"
        Me.FID_名称.Text = "XXXXXXXX10XXXXXXXX20XXXXXXXX30"
        Me.FID_名称.Top = 0!
        Me.FID_名称.Width = 2.125!
        '
        'Line5
        '
        Me.Line5.Height = 0!
        ...
        'FID_部コード
        '
        Me.FID_部コード.DataField = "部コード"
        Me.FID_部コード.Height = 0.188!
        Me.FID_部コード.Left = 0!
        Me.FID_部コード.MultiLine = False
        Me.FID_部コード.Name = "FID_部コード"
        Me.FID_部コード.OutputFormat = resources.GetString("FID_部コード.OutputFormat")
        Me.FID_部コード.Style = "font-family: \00FF2D\00FF33\000020\00660E\00671D; font-size: 9.75pt; text-align: " &
    "right; vertical-align: bottom"
        Me.FID_部コード.Text = "99"
        Me.FID_部コード.Top = 0!
        Me.FID_部コード.Width = 0.1875!
        '
        'FID_略称
        '
    ...
    "left; vertical-align: bottom"
        ...
        CType(Me.LBL_部コード, System.ComponentModel.ISupportInitialize).EndInit()
        ...
        CType(Me.FID_部コード, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Private WithEvents FID_部コード As GrapeCity.ActiveReports.SectionReportModel.TextBox
    ...
    Private WithEvents LBL_部コード As GrapeCity.ActiveReports.SectionReportModel.Label
